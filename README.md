...
|-----|-----|-----|-----|-----|
| [MedDiff-FT: Data-Efficient Diffusion Model Fine-tuning with Structural Guidance for Controllable Medical Image Synthesis](https://arxiv.org/pdf/2507.00377) | MedDiff-FT | MICAAI 2025 | [code](https://github.com/JianhaoXie1/MedDiff-FT) | diffusion生成肿瘤影像与原图计算重构损失 |
...
| Title | Abbreviation | Venue | Code | aaa |
|-----|-----|-----|-----|-----|
| [FundusGAN: A Hierarchical Feature-Aware Generative Framework for High-Fidelity Fundus Image Generation](https://arxiv.org/abs/2503.17831) | FundusGAN | arXiv 2025 | -- | FPN |
