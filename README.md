...
|-----|-----|-----|-----|-----|
| [Medical Image Synthesis via Fine-Grained Image-Text Alignment and Anatomy-Pathology Prompting](https://papers.miccai.org/miccai-2024/paper/3619_paper.pdf) | Chen et al. | MICAAI 2024 | [code](--) | 文本图像，给定词汇gpt生成 |
